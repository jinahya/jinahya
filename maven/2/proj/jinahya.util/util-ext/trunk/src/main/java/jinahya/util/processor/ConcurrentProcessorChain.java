 ...
 */
public abstract class ConcurrentProcessorChain<U extends ProcessingUnit>
     ...
     * @param size
     */
    public ConcurrentProcessorChain(final Sequencer sequencer, final int size) {
        super(sequencer);
    ...
    @Override
    public void invoke(final U unit)
