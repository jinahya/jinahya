 ...
 */
public class FormBasedFileUploadMessageBody implements MessageBody {
    ...
    @Override
    public void write(final GenericMessage message, final OutputStream stream)
        throws IOException {

        final MessageHeaders headers = message.getMessageHeaders();
        final Set<String> values = headers.getFieldValues("Content-Type");
    }
}
