 ...
 */
public class DependencyResolver2<E extends Comparable<? super E>> {
    ...
    /**
     * Check if all of specified
     * <code>targets</code> has a direct or indirect dependency from given
     * <code>source</code>.
     *
     * @param source source
     * @param targets targets
     ...
     * <code>source</code> to <code>target</code>; false if there is none.
     */
    ...
    /**
     * Finds all direct or indirect paths from given
     * <code>source</code> to specified
     * <code>target</code>.
     *
     * @param source source
     * @param target target
