...
/**
 * A status type for {@code 410 Gone} which is a member of
 * {@code Client Error 4xx}.
 *
 * @see <a href="http://tools.ietf.org/html/rfc2616#section-10.4.11">10.4.11 410
 * Gone (RFC 2616 Hypertext Transfer Protocol -- HTTP/1.1)</a>
