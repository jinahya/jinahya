...
/**
   The {@link org.havi.ui.HSinglelineEntryLook HSinglelineEntryLook}
   class is used by the {@link org.havi.ui.HSinglelineEntry
   HSinglelineEntry} component to display the entering of text.  This
   look will be provided by the platform and the exact way in which it
   is rendered will be platform dependant.

   <p>
   The {@link org.havi.ui.HSinglelineEntryLook HSinglelineEntryLook} class draws the content set on an {@link
   org.havi.ui.HSinglelineEntry HSinglelineEntry}. It uses the {@link
   ...
   the {@link org.havi.ui.HSinglelineEntry HSinglelineEntry} is
   ignored.

   <p>
   This is the default look that is used by {@link
   org.havi.ui.HSinglelineEntry HSinglelineEntry} and its subclasses.
...
public class HSinglelineEntryLook 
    implements HExtendedLook
{
    /**
     * Creates a {@link org.havi.ui.HSinglelineEntryLook HSinglelineEntryLook} object. See the class description for
