...
public class ResultSetConcurrencyTest {
    ...
    public void testToResultSet()
        ...
        for (ResultSetConcurrency value : ResultSetConcurrency.values()) {
    ...
    public void testFromResultSet()
        ...
        for (Field field : ResultSet.class.getFields()) {
            ...
            {
                try {
                    final ResultSetConcurrency type =
                        ResultSetConcurrency.valueOf(name);
            ...
            final int fieldValue = field.getInt(null);
            {
                try {
                    final ResultSetConcurrency type =
                        ResultSetConcurrency.fromFieldValue(fieldValue);
