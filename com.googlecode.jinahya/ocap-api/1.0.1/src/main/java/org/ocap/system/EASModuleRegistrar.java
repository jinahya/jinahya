 ...
 * no audio specified by SCTE 18 2001 is available.
...
public class EASModuleRegistrar {
     ...
     * EAS_FONT_OPACITY or EAS_BACK_OPACITY, this method accepts any Float 
     * value and the OCAP implementation tries to apply it. The OCAP 
