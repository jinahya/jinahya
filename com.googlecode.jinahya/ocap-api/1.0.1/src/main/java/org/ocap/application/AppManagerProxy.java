...
public class AppManagerProxy
{
     ...
     * occurs, or this method is called again.
     *
     ...
     * @throws IllegalStateException if the application, i.e. Xlet, is in the
     *         active state, or is currently set at monitor application priority.
     */
     ...
     *
     * @throws IllegalArgumentException if any key or value in the
     *      properties parameter contains a length of 0.
