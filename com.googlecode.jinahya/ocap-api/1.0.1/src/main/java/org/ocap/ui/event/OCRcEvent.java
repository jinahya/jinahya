...
public static final int OCRC_FIRST = 600;
     ...
     * input directly to the set-top RF output (toggle). This is only 
     * applicable to devices that have a channel 3/4 RF output.
     */
...
public static final int VK_PINP_DOWN = VK_PINP_UP + 1;		
     ...
     * codes.
     */
public static final int OCRC_LAST = VK_PINP_DOWN;
