...
/**
 * <p>
 * This class is used by an OCAP-J application to assume the system 
 * modules. Each system module has a unique assuming mechanism. 
 * </p><p>
 * <b>Private Host Application</b><br>
 * A Private Host Application on the Specific Application Support (SAS) 
 * Resource is an assumable system module. 
 * An OCAP-J application can register a SystemModuleHandler to take 
 * a role of a Private Host Application. 
 ...
 * Resource</b><br>
 * The MMI Resource and the Application Information Resource are the 
 * assumable modules. But the assuming mechanism is different from the 
 * Private Host Application. These Resources assume the resident 
 * Resource at the same time. The resident MMI Resource and Application 
 * Information Resource don't terminate, but they shall pass all APDU 
 * to the assuming Resources. The resident MMI dialog can be hidden. 
 * </p><p>
 * See also Section 20 <I>Baseline Functionality</I> for detailed assuming 
 * mechanism. 
 * </p>
 *
 * @author Patrick Ladd
...
public class SystemModuleRegistrar {
     ...
     * the CableCardInterface 2.0 Specification [4]. 
     * </p><p>
     ...
     * by the assuming OCAP-J application instead of the OCAP 
     * implementation. 
     * <p></p>
    ...
    /**
     * <p>
     * This method unregisters the SystemModuleHandler and the 
    ...
    /**
     * <p>
     * This method registers a SystemModuleHandler instance for the 
     * assuming MMI and Application Information Resource. 
     ...
     * instance of the assuming MMI and Application Information Resource 
     * and revives the resident MMI and Application Information Resource. 
     * </p><p>
     * In this method call, 
     * the {@link SystemModuleHandler#notifyUnregister} method of the 
