...
public abstract class VideoOutputPort
{
     ...
     * elsewhere, for example, by the OpenCable Host Core Functional Requirement, 
     * CHILA/PHILA. Note that FCC may provide rules for port disabling. 
     *
     * @throws  SecurityException if the caller has not been granted
     *		MonitorAppPermission("setVideoPort")
     *
     ...
     *          is available (TRUE) or not will return.
     ...
     *          indicates the restricted pixel size for HD video will return.
     *          </ul>
     **/
