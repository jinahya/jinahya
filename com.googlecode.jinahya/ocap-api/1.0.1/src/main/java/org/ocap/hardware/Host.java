...
public class Host {
     ...
     *
     * @return the java.util.Enumeration of references to VideoOutputPort
     * instances.
     */
     ...
     * the <i>Boot Process</i> Section of this specification will be done. 
     * </p>
     *
