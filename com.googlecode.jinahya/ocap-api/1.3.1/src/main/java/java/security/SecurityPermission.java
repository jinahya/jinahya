 ...
 * objects.
 * NOTE: <B>java.security.Signer, java.security.Identity</B> are found in J2ME 
 ...
 *   <td>Setting of the public key for an Identity
 * NOTE: <B>java.security.Identity</B> is found in J2ME CDC profiles such as 
 * J2ME Foundation Profile. </td>
 ...
 *   <td>Setting of a general information string for an Identity
 * NOTE: <B>java.security.Identity</B> is found in J2ME CDC profiles such as 
 * J2ME Foundation Profile. </td>
 ...
 *   <td>Addition of a certificate for an Identity
 * NOTE: <B>java.security.Identity</B> is found in J2ME CDC profiles such as 
 * J2ME Foundation Profile.</td>
 ...
 *   <td>Removal of a certificate for an Identity
 * NOTE: <B>java.security.Identity</B> is found in J2ME CDC profiles such as 
 * J2ME Foundation Profile.</td>
 ...
 * the Signer.
 * NOTE: <B>java.security.Signer</B> is found in J2ME CDC profiles such as 
 * J2ME Foundation Profile.</td>
 * </tr>
 *
 * <tr>
