...
public class UnsupportedPreferenceException extends java.lang.Exception {
	/**
	 * Constructs a <code>UnsupportedPreferenceException</code> with no detail message.
	 */
	public UnsupportedPreferenceException()
	{
	}
	/**
	 * Constructs a <code>UnsupportedPreferenceException</code> with a detail message.
	 *
