...
import jinahya.rfc4648.AbstractRFC4648Decoder;
 ...
 * @author Jin Kwon
 */
public class RFC4648Decoder extends AbstractRFC4648Decoder {


    public RFC4648Decoder(String alphabet, final DecodingOutputHandler handler,
                          Reader input) {
    ...
    @Override
    public void decodeFinal() throws IOException {
    ...
    protected static void decode(String alphabet, Reader input,
