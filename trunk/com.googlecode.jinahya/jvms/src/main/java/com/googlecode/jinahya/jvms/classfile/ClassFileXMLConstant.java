...
public class ClassFileXMLConstant {
    ...
    public static final String CLASSFILE_ATTRIBUTE_STACKMAP_NS_PREFIX = "stac";


    public static final String CLASSFILE_ATTRIBUTE_STACKMAP_NS_URI =
        CLASSFILE_ATTRIBUTE_NS_URI + "/stackmap";
