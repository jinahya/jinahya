...
public abstract class Machine {
     ...
     */
    public Machine(final TaskContext taskContext) throws FSMException {
        ...
        tasks = Collections.unmodifiableMap(taskContext.getTasks());
    }
    ...
    /** current state. */
    private volatile State state = UnknownState.getInstance();
