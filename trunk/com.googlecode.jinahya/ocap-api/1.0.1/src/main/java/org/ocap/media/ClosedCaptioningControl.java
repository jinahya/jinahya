...
public interface ClosedCaptioningControl extends javax.media.Control
{
     ...
     */
    void setClosedCaptioningState(int turnOn) throws SecurityException;
     ...
     *               MonitorAppPermission("handler.closedCaptioning"). 
     */
    int getClosedCaptioningState() throws SecurityException;
     ...
     * digital closed captioning will be rendered. If MPEG picture header doesn’t 
     * contain a captioning service of the digitalServiceNumber, a captioning 
     * service of analogServiceNumber in the MPEG picture header may be used 
     * instead. 
     * </p><p>
     ...
     * "-1" if no decoding of analog captioning is necessary. 
     *
     ...
     * "-1" if no decoding of digital captioning is necessary. 
     *
    ...
    * 				and the second item shall be an digital captioning service 
    * 				number. 
    * 				The array length shall be 2. 
    * 				A value "-1" indicates no captioning service number is specified 
    * 				for the captioning type. 
    *
    * @throws SecurityException if the caller doesn't have 
    * MonitorAppPermission("handler.closedCaptioning"). 
    */
    int[] getClosedCaptioningServiceNumber() throws SecurityException;
     ...
     * instance. Only service number returned by this method can be specified 
     ...
     *
     * @return  An array of closed-captioning service number that are 
