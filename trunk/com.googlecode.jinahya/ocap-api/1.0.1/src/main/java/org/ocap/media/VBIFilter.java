 ...
 * A VBIFilter instances are created by a VBIFilterGroup based on the OCAP 
 * resource management. 
...
public interface VBIFilter {
     ...
     *              the notification may be delayed and affects to the host 
     ...
     * I.e., incomplete data unit may return. 
     * When this method is called, an internal buffer is cleared once. I.e., 
     * next call returns a next byte of retrieved VBI data. 
     *
