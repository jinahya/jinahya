...
/**
 * <p>
 * The SystemModule is used by an OCAP-J application that has a role 
 * of an assuming module to send an APDU to the CableCARD device. 
...
public interface SystemModule {
     ...
     * implementation automatically when registration via the 
     ...
     * The session established by the resident MMI and Application 
     * Information Resource are used to send the APDU. If the 
     * apdu_tag indicates other Resource except MMI Resource or 
     * Application Information Resource this method doesn't throw 
     * exception but the 
     * {@link SystemModuleHandler#sendAPDUFailed} method is called 
     * to notify APDU sending failed. 
     * </p><p>
     ...
     *             is invalid (i.e., the value is for another Resource 
     *             type). 
