...
<tr>
    <td>imageFocus</td>
    <td>The image to be used as the content for the focused states of
    this component.</td>    
    <td>null</td>
    <td>{@link org.havi.ui.HVisible#setGraphicContent setGraphicContent}</td>
    <td>{@link org.havi.ui.HVisible#getGraphicContent getGraphicContent}</td>
    ...
    implements HNavigable
{
    ...
    /**
     * Creates an {@link org.havi.ui.HIcon HIcon} object. See the
     ...
     * Creates an {@link org.havi.ui.HIcon HIcon} object. See the
     * class description for details of constructor parameters and
     * default values. For constructors which specify content as parameters, 
     * see 'State-based content' in HVisible for unspecified content 
     * associated with other HStates.
     */
     ...
     * associated with other HStates.
     */
    public HIcon(Image imageNormal, Image imageFocus, int x, int y, 
     ...
     * used by default when creating a new {@link org.havi.ui.HIcon
     * HIcon} component.
     ...
     * org.havi.ui.HIcon HIcon} components.
     * 
...
public void removeHFocusListener(org.havi.ui.event.HFocusListener l)
     ...
     * HFocusEvent} sent to this {@link org.havi.ui.HIcon
     * HIcon}.
     * 
