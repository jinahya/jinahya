...
/**
   ...
   <p>
   <ul>
   <li>If the {@link org.havi.ui.HAnimation HAnimation} has different
...
<tr>
  <td>images</td>
  <td>The array of images to be used as the content for every
...
<tr> 
  <td>imagesFocused</td>
  <td>The array of images to be used as the content for the focused 
  states of this component.</td>
  <td>null</td>
  <td>{@link org.havi.ui.HVisible#setAnimateContent setAnimateContent}</td>
  <td>{@link org.havi.ui.HVisible#getAnimateContent getAnimateContent}</td>
</tr>
