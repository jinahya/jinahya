...
/**
   The {@link org.havi.ui.HGraphicLook HGraphicLook}
   class is used by any {@link org.havi.ui.HVisible 
   HVisible} component to display static graphical content. 
   This look will be provided by the platform and the exact way in
   which it is rendered will be platform dependent.

   <p>   
   The {@link org.havi.ui.HGraphicLook HGraphicLook} class draws the content set on an {@link
   org.havi.ui.HVisible HVisible}. It uses the {@link
   org.havi.ui.HVisible#getGraphicContent getGraphicContent} method
   with the current state of the {@link org.havi.ui.HVisible HVisible}
   to determine the content to render.

   <p> 
   Implementations of {@link org.havi.ui.HGraphicLook HGraphicLook} should use the appropriate methods on
   {@link org.havi.ui.HVisible HVisible} to determine which scaling
   and alignment modes to use when rendering content. See the class
   description for {@link org.havi.ui.HLook HLook} for more
   details. {@link org.havi.ui.HGraphicLook HGraphicLook} may support scalable graphical content. As a
   minimum, all implementations must support the {@link
   org.havi.ui.HVisible#RESIZE_NONE RESIZE_NONE} scaling
   ...
   for graphical content are defined to identical to {@link
   ...
   org.havi.ui.HStaticIcon HStaticIcon} and its subclasses.
...
{
    /**
     * Creates a {@link org.havi.ui.HGraphicLook HGraphicLook} object. See the class description for
