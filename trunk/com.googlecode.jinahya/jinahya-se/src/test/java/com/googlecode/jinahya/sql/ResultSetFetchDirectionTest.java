 ...
 */
public class ResultSetFetchDirectionTest
    extends FieldEnumTest<ResultSetFetchDirection, Integer> {
    ...
    public void testToResultSet()
        ...
        for (ResultSetFetchDirection value : ResultSetFetchDirection.values()) {
    ...
    public void testFromResultSet()
        ...
        for (Field field : ResultSet.class.getFields()) {
            ...
            {
                try {
                    final ResultSetFetchDirection type =
                        ResultSetFetchDirection.valueOf(name);
            ...
            final int fieldValue = field.getInt(null);
            {
                try {
                    final ResultSetFetchDirection type =
                        ResultSetFetchDirection.fromFieldValue(fieldValue);
