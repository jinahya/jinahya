...
/**
   ...
   <p> 
   The HAnimateLook class draws the content set on an {@link
   org.havi.ui.HVisible}. It uses the {@link
   org.havi.ui.HVisible#getAnimateContent}
   method with the current state of the {@link
   org.havi.ui.HVisible} to determine the content to render.
   ...
   that image is rendered statically in a similar manner to {@link
   ...
   animation with the delay specified in its associated {@link
   org.havi.ui.HStaticAnimation}. For example, if the
   ...
   {@link org.havi.ui.HVisible} to determine which scaling
   and alignment modes to use when rendering content. See the class
   description for {@link org.havi.ui.HLook} for more
   details. HAnimateLook may support scalable animated graphical content. As
   a minimum, all implementations must support the {@link
   org.havi.ui.HVisible#RESIZE_NONE} scaling
   mode, and all alignment modes.

   <p> 
   Note that the results of applying the {@link
   org.havi.ui.HVisible#VALIGN_JUSTIFY} and {@link
   org.havi.ui.HVisible#HALIGN_JUSTIFY} alignment modes
   for animated graphical content are defined to identical to {@link
   org.havi.ui.HVisible#VALIGN_CENTER} and {@link
   org.havi.ui.HVisible#HALIGN_CENTER} modes
   respectively, as justification is meaningless in this context.

   <p> 
   This is the default look that is used by {@link
   org.havi.ui.HStaticAnimation} and its subclasses.
...
public class HAnimateLook 
    implements HExtendedLook
{
    /**
     * Creates a HAnimateLook object. See the class description for
   ...
   public void widgetChanged (HVisible visible, HChangeData[] changes)
     ...
     * 
     * @param hvisible the visible to test
