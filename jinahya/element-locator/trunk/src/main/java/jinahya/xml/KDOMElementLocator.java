...
public class KDOMElementLocator extends ElementLocator<Element> {
    ...
    public String getAttribute(final String name) {
        ...
        return getAttributeNS(XmlPullParser.NO_NAMESPACE, name);
    }
    ...
    public ElementLocator<Element> setAttribute(final String name,
        ...
        return setAttributeNS(XmlPullParser.NO_NAMESPACE, name, value);
    }
    ...
    @Override
    public ElementLocator<Element> setAttributeNS(
        final String space, final String name, final String value) {
